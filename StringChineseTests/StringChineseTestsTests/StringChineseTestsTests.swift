...
class StringChineseTestsTests: XCTestCase {
    ...
    func testSimplifiedChineseText() {
        ...
        XCTAssert(text.chinesePercentage() > 80.0, "Chinese text identified as >80% Chinese")
    }
    ...
    func testEnglishText() {
        ...
        XCTAssert(text.chinesePercentage() == 0, "English text containing 0% Chinese")
    }
    
    /// Japanese contains quite many Chinese characters. Therefor the Chinese percentage is seldom close to 100% but more like something around 80%.
    func testJapaneseText() {
        ...
        XCTAssert(text.chinesePercentage() < 50.0, "Japanese text containing <50% Chinese")
    }
    ...
    func testKoreanText() {
        ...
        XCTAssert(text.chinesePercentage() == 0, "Korean text containing 0% Chinese")
    }
